...
export default function Footer() {
  return (
         ...
         <footer className="w-full pt-30 md:pt-20 pb-3 flex-col items-center justify-between bottom-0 right-0 left-0 text-center"> <div className="w-full px-5 pb-2 flex items-center justify-between border-b border-neutral-600">
