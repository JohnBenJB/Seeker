...
export default function Header() {
  return (
    <main className="relative w-screen h-290">
      <img
      ...
      <div className="relative z-10 flex flex-col">
        <div className="flex flex-col justify-between items-center text-center gap-6 pt-50">
          <h1 className="text-6xl font-bold">
            Discover Web3 Like Never <br /> Before
          </h1>
